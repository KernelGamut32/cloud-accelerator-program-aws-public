...
def lambda_handler(event, context):
    ...
    step_state = event['Input']['Payload'] #TODO
    ...
    s3_transcript_key = step_state['transcript_key'] #TODO
    ...
    output_date = date.today().strftime('%Y/%m/%d') #TODO
    output_folder = 'important' if contains_keyword else 'processed' #TODO
